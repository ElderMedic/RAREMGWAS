...
plink --bfile ${path_dir}EA127genotypes_merged --biallelic-only strict list --maf 0.01 --logistic --hide-covar --allow-no-sex --covar ${path_dir}EARTH_A_re_pc.covar --ci 0.95 --out ${path_dir}gwas_EARTHA_flipped_maf
