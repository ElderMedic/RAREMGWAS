...
plink --bfile ${path_dir}EIRA_merged --biallelic-only strict list --maf 0.01 --logistic --hide-covar --allow-no-sex --covar ${path_dir}EIRA_re_pc.covar --ci 0.95 --out ${path_dir}gwas_EIRA_flipped_maf
