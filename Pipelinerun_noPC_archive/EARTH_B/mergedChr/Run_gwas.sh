...
plink --bfile ${path_dir}EARTH_setB_merged --biallelic-only strict list --maf 0.01 --logistic --hide-covar --allow-no-sex --covar ${path_dir}EARTH_B_re_pc.covar --ci 0.95 --out ${path_dir}gwas_EARTHB_flipped_maf
