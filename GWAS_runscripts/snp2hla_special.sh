...
snp2hla=/exports/reum/knevel_lab/Scripts_Samantha/SNP2HLA_extra/SNP2HLA/
...
./SNP2HLA.csh ${NAME}_chr6 /exports/reum/knevel_lab/Scripts_Samantha/SNP2HLA_extra/SNP2HLA_package_v1.0.3/T1DGC/T1DGC_REF ${NAME}_IMPUTED ./plink 7000
